...
class EnsembleCommandesTest {
	...
	void testEstPlein() {
		//GIVEN
		EnsembleCommandes ensembleCommande1 = new EnsembleCommandes();
		int MAX_COMMANDES = 700;	
		int nbCommandes = 700;
				
		//WHEN
		ensembleCommande1.getNbCommandes();
		ensembleCommande1.estPlein();
				
		//THEN
		assertThat(ensembleCommande1.getNbCommandes()).isEqualTo(MAX_COMMANDES);
	}
	...
	void testAjouterCommande() {
		...
		//THEN
		assertThat(ensembleCommande1.ajouterCommande(commande)).isEqualTo(nbCommandes++);
	}
